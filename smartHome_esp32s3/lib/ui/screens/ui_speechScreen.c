...
void ui_speechScreen_screen_init(void)
{
    ...
    lv_obj_set_width(ui_speakButton, 75);
    lv_obj_set_height(ui_speakButton, 30);
    lv_obj_set_x(ui_speakButton, 105);
    lv_obj_set_y(ui_speakButton, -89);
    ...
    lv_chart_set_axis_tick(ui_expressionChart, LV_CHART_AXIS_PRIMARY_X, 10, 5, 5, 0, false, 60);
    lv_chart_set_axis_tick(ui_expressionChart, LV_CHART_AXIS_PRIMARY_Y, 10, 5, 5, 0, false, 50);
    lv_chart_set_axis_tick(ui_expressionChart, LV_CHART_AXIS_SECONDARY_Y, 0, 5, 5, 2, false, 0);
